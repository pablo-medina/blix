import {
    ...
    POWERUP_DURATION,
    INVINCIBLE_DURATION,
    DOUBLE_SIZE_DURATION,
    PANEL_PADDING,
    ENEMY_DESTROY_DURATION,
    MAX_ENEMIES,
    LASER_SPEED,
    LASER_WIDTH,
    LASER_HEIGHT,
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Bottom barrier blink state (used by invincible power-up)
    ...
    function createLaserShot(x: number, y: number) {
        return {
            x: x,
            y: y,
            width: LASER_WIDTH,
